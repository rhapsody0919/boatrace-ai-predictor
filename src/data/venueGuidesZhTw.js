...
export const VENUE_GUIDES_ZH_TW = [
  ...
  },
  {
    ...
    intro: [
      "戶田賽艇場位於埼玉縣戶田公園內，使用的正是1964年東京奧運划船賽事的同一條靜水賽道——是日本唯一擁有奧運歷史的賽艇場。這裡同時也是全國24座賽艇場中最狹窄的賽道，賽艇之間距離相當接近，現場觀賽格外刺激。",
  ...
  },
  {
    ...
    intro: [
      "三國賽艇場位於福井縣，是全國唯一面向日本海的賽艇場。賽道為不受潮汐影響的淡水人工水池，但隨著白天氣溫升高常會吹起海風，為賽況增添變數。由於水面不受潮汐影響，馬力強勁的賽艇往往能穩定發揮優勢。",
  ...
  },
  {
    ...
    intro: [
      "琵琶湖賽艇場位於日本最大淡水湖——琵琶湖畔，隔著湖面可眺望三上山（人稱「近江富士」）與伊吹山，是全國景色最優美的賽艇場之一。觀光遊覽船「密西根號」也經常在比賽期間於湖面上悠然行駛。",
  ...
  },
  {
    ...
    intro: [
      "尼崎賽艇場的交通便利程度在賽艇界數一數二：賽場就緊鄰阪神電鐵「尼崎中央運動公園前」站，就算下雨天也幾乎不需要撐傘。這裡的水面以全國最平穩、最考驗技術聞名，淡水賽道，船底下的水面十分紮實。",
  ...
  },
  {
    ...
    intro: [
      "丸龜賽艇場面向香川縣的瀨戶內海，賽道水質柔軟浮力佳，是全國潮差最大的賽艇場之一——高低潮位差可達約2公尺。這裡常吹逆風，「差」與「捲差」等超車戰術在此的成功率高於單純的逃走戰術。",
  ...
  },
  {
    ...
    intro: [
      "宮島賽艇場緊鄰前往宮島的渡輪碼頭，天氣晴朗時，從看台就能望見往來渡輪與UNESCO世界遺產嚴島神社的鳥居——是賽艇界數一數二壯觀的景色。這裡的瀨戶內海水面被視為全日本最考驗技術的賽道之一。",
  ...
  },
  {
    ...
    region: "長崎（九州）",
    regionGroup: "kyushu",
    tagline: "賽艇運動的發源地，也是內側最有利的賽場之一",
    intro: [
      "大村賽艇場在這項運動的歷史上佔有獨特地位：1952年4月6日，日本第一場正式的賽艇比賽便是在此舉行，是名副其實的「賽艇發源地」。後來為了支援夜間比賽而擴建了防風牆，這裡的1號艇勝率約達63%——是全國數一數二高的水準。",
