...
export const blogPostsZhTw = [
  ...
  },
  {
    ...
    description:
      "以15,000場比賽驗證AI預測的命中率・回收率。誠實公開優缺點、與其他服務的差異、AI預測的極限。",
    category: "數據分析",
  ...
  },
  {
    ...
    description:
      "解說2026年SG比賽全8戰的特徵與攻略要點。從總理盃到總決賽，介紹SG特有的預測注意事項與龍神雷達活用法。",
    category: "進階玩家",
  ...
  },
  {
    ...
    description:
      "突破抽成率25%這道牆的5個策略。以數據解說比賽篩選・投注組合種類・點數管理・資金管理・AI活用。並公開龍神雷達達成回收率104%的實績。",
    category: "策略",
  ...
  },
  {
    ...
    description:
      "徹底解說龍神雷達的展開預測功能。介紹AI如何從選手的決勝技巧分布・ST・馬達性能統計預測1轉彎迴旋的走勢，以及活用於投注策略的方法。",
    category: "使用方法",
  ...
  },
  {
    ...
    description:
      "龍神雷達的「今日精選」功能，累計2,577場比賽創下回收率104%的紀錄。公開逆轉25%抽成率、實現正收支的機制，以及誠實面對的課題。",
    category: "實績分析",
  ...
  },
  {
    ...
    description:
      "徹底解說龍神雷達的「今日精選」功能。透過15個會場・34種模式的數據挖掘，自動抽取回收率超過100%的比賽。從畫面判讀方法、依投注方式的活用法，到值得關注比賽的使用方式。",
    category: "使用方法",
  ...
  },
  {
    ...
    title: "龍神雷達突破1萬場比賽——數據回顧AI預測的實力與極限",
    description:
      "龍神雷達的累計分析比賽數突破1萬場。從12,324場數據看出單勝命中率47.4%・3連複命中率18.0%的實力，並誠實公開回收率的課題。",
    category: "實績分析",
  ...
  {
    id: "venue-ashiya",
    title: "蘆屋賽艇場攻略指南——日本內道最強的會場之一",
    description:
      "蘆屋賽艇場的特徵與攻略法，附龍神雷達實績數據。日本內道最強的會場之一。",
    category: "會場攻略",
    tags: ["蘆屋", "賽艇場", "攻略", "內道強"],
    readTime: "5分鐘",
  ...
  },
  {
    ...
    title: "龍神雷達的實績是真的嗎？徹底解說計測方法與透明度",
    description:
      "龍神雷達的命中率・回收率是如何計測的？為什麼要公開所有數據？徹底解說實績的可信度與透明度。",
    category: "數據分析",
  ...
  },
  {
    ...
    description:
      "能夠預先判斷「今天的比賽可能會爆冷」，投注策略就會改變。龍神雷達分析1,899場比賽，發現爆冷比賽共通的5個信號並公開。",
    category: "初學者向",
  ...
  },
  {
    ...
    description:
      "以每月5萬日圓為目標的資金管理方法，以及活用龍神雷達數據分析的投注思考方式。",
    category: "策略",
