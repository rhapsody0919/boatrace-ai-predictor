...
export const blogPosts = [
  ...
  },
  {
    ...
    title: "スジ舟券とは？パターン早見表と回収率が上がる買い方【保存版】",
    description:
      "スジ舟券の基本パターンを早見表で整理。イン逃げ・まくり・差し別の買い目、逆スジの見分け方、会場別の出やすさまで一目でわかる保存版ガイド。",
    date: "2026-01-30",
    category: "戦略",
  ...
  },
  {
    ...
    description:
      "ボートレースは「選手3割、モーター7割」。モーター性能が勝敗を左右する理由を徹底解説します。",
    date: "2025-12-18",
    category: "データ分析",
    tags: ["モーター", "2連対率", "性能"],
    readTime: "10分",
  ...
  },
  {
    ...
    description:
      "展示航走を見ずに舟券を買うのは損です。プロも注目する展示タイムの見方、伸び足・回り足の判断方法を徹底解説します。",
    date: "2025-12-22",
    category: "データ分析",
