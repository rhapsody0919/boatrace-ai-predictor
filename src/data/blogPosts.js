...
export const blogPosts = [
  ...
  },
  {
    ...
    description:
      "龍神レーダーが保有する実レースデータで、フライングを除いた級別の平均スタートタイミングを集計しました。A1級選手の平均ST0.146秒はB2級選手0.186秒より約1.27倍速いという結果が実データでわかりました。級によってスタート技術に差が生まれる理由と、舟券選びへの活かし方をあわせて解説します。",
    date: "2026-09-08",
    category: "データ分析",
    tags: ["選手データ", "級別", "スタートタイミング", "A1級", "B2級", "データ分析"],
    readTime: "6分",
    featured: false,
    image: "/images/blog/racer-grade-start-timing-gap.jpg",
  },
  {
    id: "racer-experience-win-rate-gap",
    title:
      "登録23年以上と11年未満、平均勝率は1.18倍差 - 実データで見る経験年数の壁",
    description:
      "龍神レーダーの実レース出走データで、直近30日間の登録期(経験年数)別平均勝率を集計しました。登録23年以上のベテラン層の平均勝率5.17%は、登録11年未満の若手層4.39%の約1.18倍という結果が実データでわかりました。経験年数と成績の関係、舟券選びへの活かし方をあわせて解説します。",
    date: "2026-09-08",
    category: "データ分析",
    tags: ["選手データ", "経験年数", "登録期", "勝率", "データ分析"],
    readTime: "6分",
    featured: false,
    image: "/images/blog/racer-experience-win-rate-gap.jpg",
  },
  {
