...
export const blogPosts = [
  {
    id: 'why-you-lose',
    title: '競艇で勝てない人の5つの共通点とAI予想による解決策',
    description: 'なぜあなたは競艇で勝てないのか？1,899レースのデータ分析から見えてきた「負けパターン」と、AI予想を使った解決策をお伝えします。',
    date: '2025-12-19',
    category: '初心者向け',
  ...
  },
  {
    ...
    description: '競艇で勝ち続けているプロは、何を買うかよりも何を買わないかを重視します。プロが絶対に買わない舟券の特徴7選を公開。',
    date: '2025-12-26',
    category: '上級者向け',
    tags: ['競艇', 'プロ', '買わない', '舟券'],
    readTime: '10分',
  ...
  },
  {
    ...
    title: '競艇で破産する人の末路と絶対に守るべき3つのルール',
    description: '競艇で人生を壊した人を実際に見てきました。破産のリアルな事例と、絶対に守るべき3つのルールをお伝えします。',
    date: '2025-12-28',
    category: 'リスク管理',
  ...
  {
    id: 'beginner-basics',
    title: '競艇初心者が知るべき5つの基本',
    description: '競艇を始めたばかりの方へ。最低限知っておくべき5つの基本知識をわかりやすく解説します。',
    date: '2025-12-15',
    category: '初心者向け',
    tags: ['競艇', '初心者', '基本'],
    readTime: '8分',
  ...
  },
  {
    ...
    description: '競艇は「選手3割、モーター7割」。モーター性能が勝敗を左右する理由を徹底解説します。',
    date: '2025-12-18',
    category: 'データ分析',
    tags: ['モーター', '2連対率', '性能'],
    readTime: '10分',
