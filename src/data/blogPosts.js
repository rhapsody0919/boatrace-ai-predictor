...
export const blogPosts = [
  ...
  },
  {
    ...
    title: "スジ舟券とは？意味と狙い目の見分け方を初心者向けに解説",
    description:
      "スジ舟券の基本パターンを早見表で整理。イン逃げ・まくり・差し別の買い目、逆スジの見分け方に加え、大村1号艇60%などイン逃げが決まりやすい会場、戸田・江戸川などまくりが出やすい会場の傾向も解説します。",
    date: "2026-01-30",
    category: "戦略",
  ...
  },
  {
    ...
    title: "【ボートレース】進入予想のコツ｜枠なり崩れを見抜く3つのサイン",
    description:
      "ボートレースは枠番通りに進入するとは限りません。前付け選手の見抜き方・深インの影響・進入が変わった時の展開予測を、龍神レーダーのデータ分析視点で解説します。",
    date: "2026-01-23",
    category: "戦略",
  ...
  },
  {
    ...
    title: "展示航走の見方3選｜フライング気味だと成功率15%低下",
    description:
      "展示航走を見ずに舟券を買うのは損。スタート展示・展示タイム・伸び足回り足の見方を解説。フライング気味の選手は本番スタート成功率が約15%低下するという龍神レーダーの分析データも公開します。",
    date: "2025-12-22",
    category: "データ分析",
