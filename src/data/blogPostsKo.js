...
export const blogPostsKo = [
  {
    ...
    description:
      "용신 레이더의 전개 예측 기능을 철저히 해설. 선수의 결정기술 분포・ST・모터 성능으로부터 1마크 회전 시의 전개를 AI가 통계적으로 예측하는 원리와 마권 전략 활용법을 소개합니다.",
    category: "사용법",
  ...
  },
  {
    ...
    description:
      "총리배부터 그랑프리까지, 2026년 SG 경주 8개 대회의 특징과 배팅 전략을 정리하고, SG 경주 예측이 일반전과 다른 이유와 용신 레이더 활용법을 소개한다.",
    category: "상급자용",
  ...
  },
  {
    ...
    description:
      '용신 레이더의 "오늘의 추천" 기능이 2,577경주에서 회수율 104%를 기록했습니다. 25%의 공제율을 넘어 플러스 수익을 유지하는 원리와 한계를 솔직하게 공개합니다.',
    category: "실적 분석",
  ...
  },
  {
    ...
    description:
      '용신 레이더의 "오늘의 추천" 기능을 완전 분석합니다. 15개 경정장·34개 패턴에 걸친 데이터 마이닝이 회수율 100% 이상 레이스를 자동으로 찾아내는 원리, 화면 보는 법, 베팅 방식별 활용법까지 소개합니다.',
    category: "사용법",
  ...
  },
  {
    ...
    title: "용신 레이더 1만 경주 돌파 - 데이터로 보는 AI 예측의 실력과 한계",
    description:
      "용신 레이더의 누적 분석 경주 수가 1만 건을 돌파했습니다. 12,324경주의 데이터가 보여주는 단승 적중률 47.4%, 삼복승 적중률 18.0%, 그리고 회수율의 실제 과제를 솔직하게 짚어봅니다.",
    category: "실적 분석",
  ...
  },
  {
    ...
    description:
      "용신 레이더 실적 데이터로 살펴보는 아시야 경정장의 특징과 공략법. 일본에서 손꼽히는 인코스 강세 경기장입니다.",
    category: "경기장별 공략",
  ...
  },
  {
    ...
    title: "용신 레이더의 실적은 진짜일까? 계측 방법과 투명성을 철저히 해설",
    description:
      "용신 레이더는 적중률과 회수율을 실제로 어떻게 계측할까요? 왜 모든 데이터를 공개할까요? 용신 레이더 실적의 신뢰성과 투명성을 철저히 해설합니다.",
    category: "데이터 분석",
  ...
  },
  {
    ...
    description:
      "이변 레이스를 미리 감지할 수 있다면 마권 전략이 달라집니다. 용신 레이더가 1,899경기를 분석해 이변 레이스에 공통된 5가지 신호를 찾아냈습니다.",
    category: "초보자용",
  ...
  },
  {
    ...
    description:
      "월 5만 엔을 목표로 하는 자금 관리법과 용신 레이더 데이터 분석을 베팅에 활용하는 방법을 소개합니다.",
    category: "전략",
