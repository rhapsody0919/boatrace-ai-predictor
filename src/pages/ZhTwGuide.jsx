...
export default function ZhTwGuide() {
  return (
    <div className="app">
      ...
      <meta
        name="description"
        content="日本賽艇（BOAT RACE / Kyotei）新手完全指南：比賽規則、獲勝方式、投注玩法，以及如何看懂 龍神雷達 的免費 AI 預測。"
      />
      ...
      <div className="eg-container">
        ...
        <section className="eg-section eg-disclaimer">
          ...
          <ul className="eg-list">
            ...
            <li>
              龍神雷達 僅提供<strong>資訊與 AI 分析</strong>
              。本站不受理投注，預測也不保證任何結果。
            </li>
            <li>
              請理性投注。詳見
