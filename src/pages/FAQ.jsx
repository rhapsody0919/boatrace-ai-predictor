  ...
  const faqs = [
    ...
    },
    {
      ...
      questions: [
        {
          q: "AI予測の精度はどのくらいですか？",
          a: "複勝予想（本命が2着以内に入るか）の的中率は約91.9%（回収率146.0%）、展開予測（1マークでの動きの予想）の的中率は約80.0%です（過去4,580レースの実測値）。各レースの予想画面・データで振り返るセクションで、毎回の的中/不的中を確認できます。",
        },
        {
