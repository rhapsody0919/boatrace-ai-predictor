    ...
    <div style={{
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#475569', lineHeight: '1.8', marginBottom: '0.75rem' }}>
          本利用規約（以下「本規約」）は、BoatAI（以下「当サイト」）が提供する競艇AI予想サービス（以下「本サービス」）の利用条件を定めるものです。
        </p>
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#475569', lineHeight: '1.8', marginBottom: '0.75rem' }}>
          本サービスは、AI技術を活用した競艇レースの予想情報を提供するサービスです。
        </p>
        <p style={{ color: '#475569', lineHeight: '1.8', marginBottom: '0.75rem' }}>
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <div style={{
          ...
          <p style={{ color: '#991b1b', lineHeight: '1.8' }}>
            競艇の舟券購入は20歳未満の方は法律で禁止されています。20歳未満の方は本サービスを利用しないでください。
          </p>
        </div>
      </section>
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#475569', lineHeight: '1.8', marginBottom: '0.75rem' }}>
          当サイトは、第三者のデータソース（公式競艇サイト等）から取得したデータを使用していますが、データの正確性について保証するものではありません。
        </p>
