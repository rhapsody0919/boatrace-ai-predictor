...
| 069 | 069_race_conditions_weather_observed_at.sql | 未適用 | 列 race_conditions.weather_observed_at が存在しない（2026-09-19、information_schema.columns で確認）。適用後に「適用済み」へ更新する |
