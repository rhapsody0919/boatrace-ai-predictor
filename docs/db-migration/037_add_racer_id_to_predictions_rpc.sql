-- get_predictions_by_date / get_predictions_by_date_light の entries に racerId を追加
-- データ出走表（DataRaceTable.jsx）の選手名を選手個別ページ（/racer/:racerId）へ
-- リンクするために必要（docs/design/racer-news-feature/screens.md「Phase2」対応）
