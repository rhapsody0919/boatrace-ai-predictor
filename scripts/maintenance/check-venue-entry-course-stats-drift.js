 ...
 *
 * reasonコード分類は scripts/lib/venueEntryCourseStats/driftHealth.js（Vercelの
 * 日次ジョブ scripts/lib/venueEntryCourseStatsJob.js と共有）。
 *
...
import { findEntryCourseStatsDriftAlerts } from "../lib/venueEntryCourseStats/driftHealth.js";
