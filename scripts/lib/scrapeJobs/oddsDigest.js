 ...
 *   - 3連単人気3位（trifecta_popular_*・trifecta_odds_*）は含めない。2026-09-20時点で、本番の全行でNULLのまま
 *     （scrape-odds.js の scrapeTrifectaOdds のセレクタ .is-p3-0 が、odds3t のページに一致しない。既存の不具合で、
 *     この移行の対象外）。全通り系の trifecta_all が、同じ情報を持つ
